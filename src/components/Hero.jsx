         ...
         <main className="container">
            <div className="content">
               <p className="text-reveal">
                  Filmmaking company based in Argentina
                  <svg
